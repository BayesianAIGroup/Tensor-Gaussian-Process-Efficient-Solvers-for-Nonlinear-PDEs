...
class DataGen:
    ...
    def __init__(self, args):
        ...
        self.x_b, self.y_b = self.train_boundary_gen()
    ...
    def test_data_gen(self):
        ...
        Y_test = vmap(u_AllenC)(X_test[:, 0], X_test[:, 1])
    ...
    def train_boundary_gen(self):
        ...
        # Y_train_bound = vmap(u_AllenC)(X_train_bound[:, 0], X_train_bound[:, 1])
        ...
        Y_train_bound = vmap(u_AllenC, (0, 0))(X_train_bound[:, 0], X_train_bound[:, 1])
