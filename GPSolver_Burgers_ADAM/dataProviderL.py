...
class DataGen:
    ...
    def __init__(self, args):
        ...
        x1_range = self.x_range[0]
        self.x1_point_train = np.linspace(x1_range[0], x1_range[-1], self.args.n_xind[0])

        x2_range = self.x_range[1]
        self.x2_point_train = np.linspace(x2_range[0], x2_range[-1], self.args.n_xind[1])
    ...
    def test_data_gen(self, Gauss_pts, weights):
        ...
        return jnp.array(X_test), jnp.array(Y_test)
