...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-xind', nargs='+', default=[700, 40, 700, 40, 40, 40], type=int,
    ...
    parser.add_argument('--dataset-load-path', type=str, default="./dataset/Dim6/Allen_CahenC96000_B19200.npz", metavar='FILE',
                        help='path to load the dataset')
    parser.add_argument('--test-dataset-load-path', type=str, default="./dataset/Dim6/Allen_Cahen_Test1000000.npz", metavar='FILE',
                        help='path to load the dataset')
