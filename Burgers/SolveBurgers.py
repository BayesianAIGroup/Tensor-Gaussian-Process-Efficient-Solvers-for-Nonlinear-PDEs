...
#use Jax_env
#Implementation of TGP Solver with Piccard's iteration for solving the Burgers Equation
#u_t + uu_x - nu*u_xx = 0
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GP Solver for Burgers Using ALS on CP Decomposition')
    ...
    parser.add_argument('--n-train-batch', type=int, default=32000, metavar='N',
