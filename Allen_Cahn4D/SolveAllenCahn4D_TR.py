...
from model_TR import GP_ALS_4D
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-xind', nargs='+', default=[10, 5, 7, 4], type=int,
                        help='num of inducing points by each dim ')

    
    parser.add_argument('--jitter', nargs='+', default=[23.0, 13.1, 13.1, 13.1], type=float, 
                        help='Positive Definite for Kernel (default: 23.0)')
    parser.add_argument('--log-lsx', nargs='+', default=[-4.5, -1.5, -4.5, -1.5], type=float,
                        help='log landscale per dim (default: -4.5)')
    parser.add_argument('--kernel-s', nargs='+', default=[1, 3, 1, 3], type=int, 
                        help='kernel selection: 0: 0.5, 1: 1.5, 2: 2.5, 3: 3.5, 4: 4.5, 5: inf')
    
    parser.add_argument('--rank', nargs='+', default=[4, 5, 10, 5], type=int, 
    ...
    parser.add_argument('--n-order', type=int, default=4, metavar='N',
