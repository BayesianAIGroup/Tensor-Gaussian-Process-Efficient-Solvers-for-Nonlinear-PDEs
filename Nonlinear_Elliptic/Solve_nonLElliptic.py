...
#use Jax_env
#Implementation of TGP Solver with Piccard's iteration for solving the nonLinear Elliptic
# - u_xx - u_yy + u**3 = f(x, y) with ground truth u = sin(pi * x) * sin(pi * y) + 4.0 * sin(4.0 * pi * x) * sin(4.0 * pi * y)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GP Solver for Non-Linear Elliptic Using ALS on CP Decomposition')
