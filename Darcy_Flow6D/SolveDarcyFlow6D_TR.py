...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GP Solver for DarcyFlow Houman Using ALS on Tensor Ring Decomposition')
    ...
    parser.add_argument('--n-train-batch', type=int, default=25000, metavar='N',
    ...
    parser.add_argument('--stop-criteria', type=float, default=0.0000001, metavar='IC',
