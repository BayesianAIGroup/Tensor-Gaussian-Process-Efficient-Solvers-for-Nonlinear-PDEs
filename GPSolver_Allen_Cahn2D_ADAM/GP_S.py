...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GP Solver for Allen Can')
    parser.add_argument('--n-x1test', type=int, default=10, metavar='N',
                        help='number of points along 1st dir for test dataset (default: 10)')
    parser.add_argument('--n-x2test', type=int, default=10, metavar='N',
    ...
    parser.add_argument('--rank', nargs='+', default=[3, 5], type=int,
                        help='rank per each variable')
    parser.add_argument('--kernel-s', nargs='+', default=[2, 2], type=int, 
                        help='kernel selection: 0: 0.5, 1: 1.5, 2: 2.5, 3: 3.5, 4: 4.5, 5: inf')
    parser.add_argument('--jitter', nargs='+', default=[1.0e-11, 1.0e-11], type=float, 
                        help='noise set on each kernel')
    parser.add_argument('--log-lsx', nargs='+', default=[1.0, 2.0], type=float, 
    ...
    parser.add_argument('--gamma', type=float, default=1.0, metavar='N',
                        help='coefficient for PDE(default: 1.0)')
    parser.add_argument('--m', type=int, default=3, metavar='N',
                        help='coefficient for PDE(default: 3)')
    parser.add_argument('--a', type=float, default=15.0, metavar='N',
                        help='coefficient for PDE(default: 15.0)')
